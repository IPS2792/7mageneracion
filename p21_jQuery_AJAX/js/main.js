...
const getKodersFromDb = () => {
    kodersArray = [];
    $.ajax({
        url:"https://javascript-ajax-d0ce6.firebaseio.com/ivan/koders/.json",
        method:"GET",
        success:(response) => {
...
const deleteKoderInDb = () => {
    ...
    $.ajax({
        url:`https://javascript-ajax-d0ce6.firebaseio.com/ivan/koders/${koderKey}.json`,
        method:"DELETE",
        success:(response)=>{
